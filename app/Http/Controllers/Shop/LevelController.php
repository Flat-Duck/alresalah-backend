...
class LevelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.levels.index', compact('levels', 'search'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('shop.levels.create');
    }
    ...
    public function show(Request $request, Level $level)
    {
        ...
        return view('shop.levels.show', compact('level'));
    }
    ...
    public function edit(Request $request, Level $level)
    {
        ...
        return view('shop.levels.edit', compact('level'));
    }
